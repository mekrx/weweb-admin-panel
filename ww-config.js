export default {
    editor: {
        ...
        customStylePropertiesOrder: [
            ...
            ['labelTabRoles','labelTabVisibility','labelTabDepts','labelUserDepts','labelAssignedRoles','labelPermissions','labelVisibleClients'],
    ...
    properties: {
        ...
        labelColDept: { label:{en:'Col: Dept header text', pl:'Nagłówek kolumny: Oddział'}, type:'Text', defaultValue:'ODDZIAŁ', bindable:true },
